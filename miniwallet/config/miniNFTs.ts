...
export default {
  ...
  mini1155: {
    collection1: {
      ...
      mintPrice: ethers.utils.parseEther(process.env.MINI1155_COLLECTION1_MINT_PRICE || '0.042'),
    ...
    collection2: {
      ...
      mintPrice: ethers.utils.parseEther(process.env.MINI1155_COLLECTION2_MINT_PRICE || '0.084'),
